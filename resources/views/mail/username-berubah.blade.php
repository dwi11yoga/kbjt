            ...
            <td style="text-align: center; vertical-align: middle; width: 100%">
                <div style="display: inline-block; margin: 0 auto; text-align: left; max-width: 600px; width: 100%;">
                    ...
                    <div class="box"
                        ...
                        <p>{{ $user->nama }},</p>
                        <p>
                            Kami ingin memberitahu bahwa username akun Kamus Bahasa Jawa Terbuka
                            kamu telah berhasil diperbarui menjadi {{ $usernameBaru }} pada {{ $tanggal }} pukul
                            {{ $waktu }}.
                        </p>
                        <p>
                            Jika kamu tidak merasa melakukan perubahan ini, atau memiliki pertanyaan lebih lanjut,
                            segera hubungi tim kami melalui alamat email atau media sosial kami untuk tindakan lebih lanjut.
                        </p>
                        <p>
