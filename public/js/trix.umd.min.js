...
// Upload gambar
(function () {
    // Event listener untuk mendeteksi file yang ditambahkan ke Trix Editor
    ...
    function uploadFileAttachment(attachment) {
        ...
        // Fungsi untuk mengatur progress upload
        function setProgress(progress) {
            attachment.setUploadProgress(progress);
        }

        // Fungsi untuk mengatur atribut gambar setelah berhasil diupload
        function setAttributes(attributes) {
            attachment.setAttributes(attributes);
        }
    }

    // Fungsi untuk melakukan upload file menggunakan Fetch API
    function uploadFile(file, progressCallback, successCallback) {
        const formData = new FormData();
        formData.append("file", file);

        // Gunakan endpoint upload Laravel
        fetch("/upload-image", {
            method: "POST",
            headers: {
...
(function () {
    // console.log("Listening to trix-attachment-remove event.");
    addEventListener("trix-attachment-remove", function (event) {
        const attachmentUrl = event.attachment.getAttribute("url");
        if (attachmentUrl) {
