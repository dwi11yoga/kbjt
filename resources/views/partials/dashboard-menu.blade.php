    ...
    <div class="space-y-1 mt-5 overflow-y-auto row-span-10">
        ...
        <a href="/achievement">
            <div
                ...
                <i data-feather='star'
                    class="{{ $group == 'achievement' ? 'fill-neutral-800 stroke-neutral-800' : 'text-neutral-700 group-hover:text-black' }}"></i>
                {{-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
<div id="menu" class="fixed w-full h-full grid grid-row-6 bg-white px-5 z-20 invisible">
    ...
    <div class="space-y-1 overflow-y-auto row-span-4">
        ...
        <a href="/dashboard">
            <div
                class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'dashboard' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                <i data-feather='grid'
                    class="{{ $group == 'dashboard' ? 'fill-neutral-800 text-neutral-800' : 'text-neutral-700 group-hover:text-black' }}"></i>
                <div
                    class="inline-block ml-3 {{ $group == 'dashboard' ? '' : 'text-neutral-700 group-hover:text-black' }}">
        ...
        @if (auth()->user()->role == 'kontributor' || auth()->user()->role == 'pengurus')
            ...
            <a href="/kontribusi">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'kontribusi' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <i data-feather='edit-2'
                        class="{{ $group == 'kontribusi' ? 'fill-neutral-800 stroke-none' : 'text-neutral-700 group-hover:text-black' }}"></i>
                    <div
                        class="inline-block ml-3 {{ $group == 'kontribusi' ? '' : 'text-neutral-700 group-hover:text-black' }}">
        ...
        @if (auth()->user()->role == 'pengurus' || auth()->user()->role == 'kepala')
            ...
            <a href="/artikel">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'artikel' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <i data-feather='align-left'
                        class="{{ $group == 'artikel' ? '' : 'text-neutral-700 group-hover:text-black' }}"></i>
                    <div
                        class="inline-block ml-3 {{ $group == 'artikel' ? '' : 'text-neutral-700 group-hover:text-black' }}">
            ...
            <a href="/banner">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'banner' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-image">
                        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"
            ...
            <a href="/kontributor">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'kontributor' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-users">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"
            ...
            <a href="/pengurus">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'pengurus' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-users">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"
            ...
            <a href="/laporan">
                <div
                    class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'laporan' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                    <i data-feather='flag'
                        class="{{ $group == 'laporan' ? 'fill-neutral-800 stroke-neutral-800' : 'text-neutral-700 group-hover:text-black' }}"></i>
                    <div
                        class="inline-block ml-3 {{ $group == 'laporan' ? '' : 'text-neutral-700 group-hover:text-black' }}">
        ...
        <a href="/sertifikat">
            <div
                class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'sertifikat' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                {{-- <i data-feather='file-text' class="{{ $group == 'sertifikat' ? '' : 'text-neutral-700 group-hover:text-black' }}"></i> --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <a href="/achievement">
            <div
                class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'achievement' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                <i data-feather='star'
                    class="{{ $group == 'achievement' ? 'fill-neutral-800 stroke-neutral-800' : 'text-neutral-700 group-hover:text-black' }}"></i>
                {{-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <a href="/pengaturan">
            <div
                class="flex group py-4 px-6 w-fit rounded-2xl {{ $group == 'settings' ? 'bg-amber-100' : 'hover:bg-neutral-100' }}">
                {{-- <i data-feather='settings' class="{{ $group == 'settings' ? 'fill-neutral-800 stroke-none' : 'text-neutral-700 group-hover:text-black' }}"></i> --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="feather feather-settings">
