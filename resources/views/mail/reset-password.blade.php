            ...
            <td style="text-align: center; vertical-align: middle; width: 100%">
                <div style="display: inline-block; margin: 0 auto; text-align: left; max-width: 600px; width: 100%;">
                    ...
                    <div class="box"
                        ...
                        <p>{{ $user['nama'] }},</p>
                        <p>
                            Kami menerima permintaan untuk mereset kata sandi akun Kamus Bahasa Jawa Terbuka milikmu.
                            Jika kamu memang mengajukan permintaan ini, silakan gunakan kode berikut untuk melanjutkan
                            proses reset. Kode ini hanya berlaku selama lima menit, sehingga kamu perlu segera
                            menindaklanjutinya.
                        </p>
                        <p>
                            Kode: <br>
                            <span style="font-weight: 800; letter-spacing: 1rem; font-size: larger;">{{ $kode }}</span>
                        </p>
                        <p>
                            Jangan bagikan kode ini kepada siapa pun. Jika kamu tidak merasa melakukan permintaan ini,
                            abaikan saja email ini. Akun kamu akan tetap aman dan tidak ada perubahan yang terjadi.
                        </p>
