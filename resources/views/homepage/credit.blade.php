...
@section('body')
    ...
    <div class="md:space-x-2">
        <img src="{{ asset('img/disdikbud-pati.png') }}" class="md:h-24 h-20 inline" alt="Logo Dinas Pendidikan dan Kebudayaan">
    ...
    <div class="">
        ...
        <div class="my-3 flex space-x-1">
            ...
            {{-- discord --}}
            <a href="https://discord.com/invite/kbjt" target="_blank" title="Bergabung dengan komunitas kbjt di discord">
                <div class="bg-neutral-200 rounded-lg py-3 px-3 w-fit group hover:bg-blue-700">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" class="fill-blue-700 group-hover:fill-white"
