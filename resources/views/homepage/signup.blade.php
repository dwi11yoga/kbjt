            ...
            <div class="grid grid-cols-7 space-x-3 mt-6">
                ...
                <div class="col-span-6">
                    <input type="submit" value="Buat akun"
                        class="block bg-yellow-400 text-center p-3 w-full rounded-full cursor-pointer hover:outline hover:outline-2 hover:outline-offset-2 hover:outline-yellow-400 active:bg-yellow-300">
                </div>
            </div>
        </div>
    </form>
    <p id="masuk" class="mt-3 hidden">Sudah punya akun? <a href="/masuk"
            class="text-blue-600 hover:underline hover:underline-offset-4 hover:decoration-yellow-400 hover:decoration-[3px] active:text-blue-800">Masuk</a>.
    </p>
