...
@section('body')
    ...
    <div class="w-full border border-gray-200 rounded-2xl py-6 px-7">
        ...
        <label for="metode-pembayaran" class="block mb-2 text-sm font-medium text-gray-800">Metode
            donasi</label>
        <form action="/donasi" method="GET" class="relative justify-between">
        ...
        <div class="grid grid-cols-4 md:space-x-5 mt-5 md:space-y-0 space-y-5">
            ...
            <div class="md:col-span-1 col-span-4">
                <div class="rounded-2xl bg-neutral-200 w-full !aspect-square flex items-center justify-center">
                    <img src="{{ $donasi->barcode ?? null }}" alt="Barcode tidak tersedia">
                </div>
            </div>
