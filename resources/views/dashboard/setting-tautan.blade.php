...
@section('body')
    <form action="/pengaturan/tautan/simpan" method="POST" class="space-y-3">
        ...
        {{-- Media sosial --}}
        <div class="bg-white px-5 py-4 rounded-xl space-x-1">
            <div class="text-sm">Media sosial</div>
            ...
            {{-- x --}}
            <label for="x" class="text-sm">Twitter/X</label>
            ...
            <input type="text" id="wa" name="wa" placeholder="Masukkan telepon" title="Klik untuk edit"
