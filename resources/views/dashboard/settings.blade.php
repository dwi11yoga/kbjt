        ...
        <div class="bg-white p-5 rounded-2xl">
            ...
            <div class="space-y-2">
                <a href="/pengaturan/edit-user"
                    class="block py-4 px-5 w-full border bg-white border-gray-200 rounded-xl shadow-sm cursor-pointer active:bg-yellow-200 hover:outline hover:outline-amber-400 outline-offset-2">
        ...
        <div class="bg-white rounded-2xl p-5">
            ...
            <div class="space-y-2">
                ...
                <form action="/logout" method="POST">
                    @csrf
                    <button type="submit"
                        class="block py-4 px-5 w-full text-left border text-red-600 bg-white border-gray-200 rounded-xl shadow-sm cursor-pointer active:text-black active:bg-red-200 hover:outline hover:outline-red-500 outline-offset-2">
